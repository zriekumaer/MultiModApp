...
public class PdfGenerator {
    ...
    public ByteArrayInputStream generate(Invoice invoice) {
        ...
        try {
            ...
            PdfPCell companySealCell = new PdfPCell(new Phrase("piecz?? firmy", helvetica9));
            ...
            PdfPCell createDateCell = new PdfPCell(new Phrase("Data wystawienia: " + Chunk.NEWLINE + invoice.getCreatedDate(), helvetica14));
            ...
            PdfPCell saleDateCell = new PdfPCell(new Phrase("Data sprzeda?y: " + Chunk.NEWLINE + invoice.getSaleDate(), helvetica14));
...
//            PdfPCell paymentTypeCell = new PdfPCell(new Phrase("Sposób p?atno?ci: " + invoice.getPaymentType().getName(), helvetica12));
//            informationTable.addCell(paymentTypeCell);
//
//            PdfPCell paymentDateCell = new PdfPCell(new Phrase("Termin p?atno?ci: " + invoice.getPaymentDate().format(df), helvetica12));
//            informationTable.addCell(paymentDateCell);
            ...
            headerPositionCell = new PdfPCell(new Phrase("Ilo??", helvetica_bold12));
            headerPositionCell.setHorizontalAlignment(Element.ALIGN_CENTER);
            positionsTable.addCell(headerPositionCell);
            ...
            headerPositionCell = new PdfPCell(new Phrase("Warto?? netto", helvetica_bold12));
            headerPositionCell.setHorizontalAlignment(Element.ALIGN_CENTER);
            positionsTable.addCell(headerPositionCell);
            ...
            headerPositionCell = new PdfPCell(new Phrase("Warto?? brutto", helvetica_bold12));
            headerPositionCell.setHorizontalAlignment(Element.ALIGN_CENTER);
            positionsTable.addCell(headerPositionCell);
...
//            }
            ...
            PdfPCell toPayCell = new PdfPCell(new Phrase("Razem do zap?aty: " + invoice.getGrossAmount() + " PLN", helvetica_bold14));

            PdfPTable signatureTable = new PdfPTable(2);

            PdfPCell clientSignatureCell = new PdfPCell(new Phrase("Imi? i nazwisko osoby upowa?nionej do odebrania dokumentu", helvetica9));
            ...
            PdfPCell userSignatureCell = new PdfPCell(new Phrase("Imi? i nazwisko osoby upowa?nionej do wystawienia dokumentu", helvetica9));
            clientSignatureCell.setPaddingLeft(10);
            clientSignatureCell.setPaddingRight(10);
